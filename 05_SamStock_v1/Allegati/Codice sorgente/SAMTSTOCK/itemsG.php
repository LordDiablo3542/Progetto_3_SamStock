			...
			?>
				...
				<div id="allitems">
					<?php
						...
						$result = mysqli_query($con,"SELECT ID_Prodotto, NomeP, NomeC, Modello, `Numero di serie`, Disponibile, Portabile, Aula, Descrizione, Prezzo, Quantita FROM prodotti p JOIN categorie c ON p.Categoria = c.ID_Categoria ORDER BY NomeP ASC;");
						$search = false;
