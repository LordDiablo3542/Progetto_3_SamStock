...
-- Dump della struttura del database samtstock
CREATE DATABASE IF NOT EXISTS `samtstock` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `samtstock`;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='Tabella con tutte le informazione di un determinato oggetto nel magazzino.';
